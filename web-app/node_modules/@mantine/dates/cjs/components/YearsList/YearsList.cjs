    ...
    const cells = yearsRow.map((year, cellIndex) => {
      ...
      return /* @__PURE__ */ React__default.default.createElement(
        ...
        /* @__PURE__ */ React__default.default.createElement(
          ...
          dayjs__default.default(year).locale(ctx.getLocale(locale)).format(yearsListFormat)
        )
      );
    });
    return /* @__PURE__ */ React__default.default.createElement("tr", { key: rowIndex, ...getStyles("yearsListRow") }, cells);
  });
  return /* @__PURE__ */ React__default.default.createElement(core.Box, { component: "table", ref, size, ...getStyles("yearsList"), ...others }, /* @__PURE__ */ React__default.default.createElement("tbody", null, rows));
});
