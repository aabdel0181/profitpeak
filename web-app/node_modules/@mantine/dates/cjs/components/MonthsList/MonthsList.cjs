    ...
    const cells = monthsRow.map((month, cellIndex) => {
      ...
      return /* @__PURE__ */ React__default.default.createElement(
        ...
        /* @__PURE__ */ React__default.default.createElement(
          ...
          dayjs__default.default(month).locale(ctx.getLocale(locale)).format(monthsListFormat)
        )
      );
    });
    return /* @__PURE__ */ React__default.default.createElement("tr", { key: rowIndex, ...getStyles("monthsListRow") }, cells);
  });
  return /* @__PURE__ */ React__default.default.createElement(core.Box, { component: "table", ref, size, ...getStyles("monthsList"), ...others }, /* @__PURE__ */ React__default.default.createElement("tbody", null, rows));
});
