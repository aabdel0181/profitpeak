...
const DateInput = core.factory((_props, ref) => {
  ...
  const _rightSection = rightSection || (clearable && _value && !readOnly ? /* @__PURE__ */ React__default.default.createElement(
    core.CloseButton,
    {
      variant: "transparent",
  ...
  return /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, /* @__PURE__ */ React__default.default.createElement(core.Input.Wrapper, { ...wrapperProps, __staticSelector: "DateInput" }, /* @__PURE__ */ React__default.default.createElement(
    core.Popover,
    {
    ...
    /* @__PURE__ */ React__default.default.createElement(core.Popover.Dropdown, { onMouseDown: (event) => event.preventDefault(), "data-dates-dropdown": true }, /* @__PURE__ */ React__default.default.createElement(
      Calendar.Calendar,
      {
        __staticSelector: "DateInput",
  ...
  )), /* @__PURE__ */ React__default.default.createElement(HiddenDatesInput.HiddenDatesInput, { name, form, value: _value, type: "default" }));
});
