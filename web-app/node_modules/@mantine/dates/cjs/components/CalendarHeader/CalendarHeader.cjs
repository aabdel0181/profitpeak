...
const CalendarHeader = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(core.Box, { ...getStyles("calendarHeader"), ref, ...others }, withPrevious && /* @__PURE__ */ React__default.default.createElement(
    core.UnstyledButton,
    {
    ...
    previousIcon || /* @__PURE__ */ React__default.default.createElement(
    ...
    label
  ), withNext && /* @__PURE__ */ React__default.default.createElement(
    core.UnstyledButton,
    {
      ...getStyles("calendarHeaderControl"),
      "data-direction": "next",
    ...
    nextIcon || /* @__PURE__ */ React__default.default.createElement(
      core.AccordionChevron,
      {
        ...getStyles("calendarHeaderControlIcon"),
        "data-direction": "next",
