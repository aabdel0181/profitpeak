...
const Calendar = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(core.Box, { ref, size, "data-calendar": true, ...others }, _level === "month" && /* @__PURE__ */ React__default.default.createElement(
  ...
  ), _level === "year" && /* @__PURE__ */ React__default.default.createElement(
  ...
  ), _level === "decade" && /* @__PURE__ */ React__default.default.createElement(
