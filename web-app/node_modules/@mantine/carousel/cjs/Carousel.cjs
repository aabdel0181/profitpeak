...
const Carousel = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Carousel_context.CarouselProvider, { value: { getStyles, orientation } }, /* @__PURE__ */ React__default.default.createElement(CarouselVariables.CarouselVariables, { ...props, selector: `.${responsiveClassName}` }), /* @__PURE__ */ React__default.default.createElement(
    ...
    withIndicators && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("indicators"), "data-orientation": orientation }, indicators),
    withControls && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("controls"), "data-orientation": orientation }, /* @__PURE__ */ React__default.default.createElement(
      core.UnstyledButton,
      {
        ...previousControlProps,
        ...getStyles("control", {
