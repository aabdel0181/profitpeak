...
const Carousel = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(CarouselProvider, { value: { getStyles, orientation } }, /* @__PURE__ */ React.createElement(CarouselVariables, { ...props, selector: `.${responsiveClassName}` }), /* @__PURE__ */ React.createElement(
    ...
    withIndicators && /* @__PURE__ */ React.createElement("div", { ...getStyles("indicators"), "data-orientation": orientation }, indicators),
    withControls && /* @__PURE__ */ React.createElement("div", { ...getStyles("controls"), "data-orientation": orientation }, /* @__PURE__ */ React.createElement(
      UnstyledButton,
      {
        ...previousControlProps,
        ...getStyles("control", {
