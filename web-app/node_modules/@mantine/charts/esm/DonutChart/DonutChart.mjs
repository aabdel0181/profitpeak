...
const DonutChart = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { ref, size, ...getStyles("root"), ...others }, /* @__PURE__ */ React.createElement(ResponsiveContainer, null, /* @__PURE__ */ React.createElement(PieChart, { ...pieChartProps }, /* @__PURE__ */ React.createElement(
    Pie,
    {
      data,
    ...
    cells
  ), chartLabel && /* @__PURE__ */ React.createElement(
    "text",
    {
      x: "50%",
      y: "50%",
